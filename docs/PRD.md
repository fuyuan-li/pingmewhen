...
- Start the local HTTPS tunnel with standard Relay, visibly probe public health before an approved call, and treat the probe as diagnostic rather than a dialing gate.
