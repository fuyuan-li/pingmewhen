        ...
        input_messages = [
            {
                ...
                "content": (
                    ...
                    "their own name anywhere in the conversation — for example 'I'm David', 'my name is David', "
                    "'this is David', or '我是David' — treat that name as the confirmed caller_name and DO NOT ask "
                    "for it again; put it straight into caller_name and proceed. Only when no usable self-name "
                    "appears anywhere in the whole conversation should you return needs_input and ask once, warmly "
                    "and in the user's language, briefly explaining that Relay needs it to introduce the call on "
                    "their behalf; a first name or nickname is enough, and never demand a legal name. If the "
                    "conversation says the caller name is already confirmed, preserve it and do not ask again. "
