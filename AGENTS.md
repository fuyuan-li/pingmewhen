...
- Production execution currently supports approved outbound phone actions only. Browser microphone takeover, secure local payment audio, automatic structured extraction/comparison, retries, and non-phone tools do not work yet. Do not imply otherwise.
